  ...
  return (
    <>
        <div className='house-bg content-center text-center p-5 lg:p-20'>
            ...
            <p className='hidden lg:block text-white mt-8 text-md md:text-xl mb-5'>Whether you're looking to buy your first home or sell a property, <br /> our platform offers a seamless and secure experience. Discover the perfect place with our <br /> easy-to-use search tools and verified listings.          
            </p>
            ...
            <Button 
            className={'rounded-md py-2 md:px-2 md:mt-8 text-white bg-orange-600 w-full md:w-1/2 md:h-[50px] text-sm lg:text-xl'}
          ...
          <p className='text-xl my-3 text-white'>OR</p>
           <Link to="/login">
           <Button 
            className={'rounded-md py-2 md:px-2  text-white bg-orange-600 w-full md:w-1/2 md:h-[50px] text-sm lg:text-xl'}
